...
L2	
	...
	lw r3,cs(r3)
	add r14,r0,r3
	j L12	% Compiler.Tac.Instruction+Goto
L12	
		% Compiler.Tac.Instruction+Assign
	addi r3,r1,8
	lw r3,0(r3)
...
L3	
	...
	lw r3,cs(r3)
	putc r3
	j L15	% Compiler.Tac.Instruction+Goto
L14	
		% Compiler.Tac.Instruction+Write
	addi r3,r0,108
	lw r3,cs(r3)
...
L20	
	...
	addi r13,r1,12
	sw 0(r13),r3
	j L23	% Compiler.Tac.Instruction+Goto
L22	
L23	
L21	
		% Compiler.Tac.Instruction+Push
...
L26	
	...
	lw r3,cs(r3)
	add r14,r0,r3
	j L24	% Compiler.Tac.Instruction+Goto
L24	
		% Compiler.Tac.Instruction+Assign
	addi r3,r1,8
	lw r3,0(r3)
